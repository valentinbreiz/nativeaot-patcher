...
// Ported from Cosmos.System2/Keyboard/ScanMaps/DEStandardLayout.cs
...
public class DEStandardLayout : ScanMapBase
{
    ...
    protected override void InitKeys()
    {
        ...
        Keys.Add(new KeyMapping(0x1A, 'ü', 'Ü', 'ü', 'Ü', 'ü', 'Ü', ConsoleKeyEx.LBracket));
        ...
        Keys.Add(new KeyMapping(0x27, 'ö', 'Ö', 'ö', 'Ö', 'ö', 'Ö', ConsoleKeyEx.Semicolon));
        Keys.Add(new KeyMapping(0x28, 'ä', 'Ä', 'ä', 'Ä', 'ä', 'Ä', ConsoleKeyEx.Apostrophe));
        Keys.Add(new KeyMapping(0x29, '#', '\'', '#', '\'', '#', '\'', ConsoleKeyEx.Backslash));
        /* Left Shift*/
        Keys.Add(new KeyMapping(0x2A, ConsoleKeyEx.LShift));
        /* <yxcvbnm,.-          >YXCVBNM;:_         |______µ___ */
        Keys.Add(new KeyMapping(0x2B, '<', '>', '<', '>', '<', '>', '|', '|', ConsoleKeyEx.OEM102));
