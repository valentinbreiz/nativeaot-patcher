...
namespace Cosmos.Kernel.System.Graphics
{
    ...
    public class SVGAII3DCanvas : Canvas
    {
        ...
        int Stride, Pitch, BytesPerPixel;

        Mode mode;
        public readonly VMWareSVGAII3D driver;

        /// <summary>
        /// Initializes a new instance of the <see cref="SVGAII3DCanvas"/> class.
        /// </summary>
        ...
        public SVGAII3DCanvas(Mode aMode) : base(aMode)
        {
