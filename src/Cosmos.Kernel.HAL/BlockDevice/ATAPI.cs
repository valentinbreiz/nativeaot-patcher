...
//     {
//         device = parentDevice;
//         BusPosition = parentDevice.BusPosition;
//         Primary = parentDevice.ControllerID == ControllerIdEnum.Primary;
//
...
//     private void HandleIRQ(ref INTs.IRQContext aContext) => ataDebugger.Send("ATAPI IRQ");
//
//     /// <summary>
...
//         if (SectorCount != 1)
//         {
//             throw new NotImplementedException("Reading more than one sectors is not supported. SectorCount: " +
//                                               SectorCount);
//         }
//
...
//         packet[11] = 0;
//
//         ushort[] buffer = new ushort[SectorSize / 2]; //Divide by 2 because we are reading words
...
//         IOPort.Write8(IO.DeviceSelect,
//             (byte)((byte)(DvcSelVal.Default | DvcSelVal.LBA |
//                           (BusPosition == BusPositionEnum.Slave ? DvcSelVal.Slave : 0)) | 0));
//
...
//         {
//             byte b1 = AtapiPacket[i];
//             byte b2 = AtapiPacket[i + 1];
//
//             ushort toSend = BitConverter.ToUInt16(new byte[] { b1, b2 }, 0);
...
//         Poll(true);
//         CheckForErrors();
//         int a = IOPort.Read8(IO.LBA2) << 8;
//
//         int size2 = a | IOPort.Read8(IO.LBA1);
//         if (size != size2)
//         {
...
//                     (IOPort.Read8(IO.Status) & (byte)ATA_PIO.Status.DRQ) != 0)
//                 {
//                     break;
//                 }
//             }
