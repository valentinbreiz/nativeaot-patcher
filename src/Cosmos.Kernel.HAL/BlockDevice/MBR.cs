...
using Cosmos.Kernel.Core.Extensions;
...
public class MBR
{
    ...
    public void WritePartitionInformation(Partition partition, byte PartitionNo)
    {
        ...
        byte[] mb = new byte[512];
        partition.Host.ReadBlock(0, 1, ref mb);
        ...
        partition.Host.WriteBlock(0, 1, ref mb);
        ParsePartition(mb, 446 + (uint)(PartitionNo * 16));
