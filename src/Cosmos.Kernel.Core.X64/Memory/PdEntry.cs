...
/// Can be a table descriptor to a PT or a 2 MiB page/block descriptor.
/// </summary>
[StructLayout(LayoutKind.Explicit, Size = 8)]
public struct PdEntry
{
    [FieldOffset(0)]
    ...
    /// <summary>
    /// Creates a PD table descriptor pointing to a PT.
    /// </summary>
    public static PdEntry Table(ulong physicalAddress, bool user = false, bool writable = true)
    {
        PdEntry entry = default;
        entry._entry = PageTableEntry.Table(physicalAddress, user, writable);
        return entry;
    }

    /// <summary>
    /// Creates a 2 MiB page/block descriptor.
    /// </summary>
    public static PdEntry Page(ulong physicalAddress, PageFlags flags)
    {
        PdEntry entry = default;
