...
namespace Liquip.Patcher.Analzyer.Test.Utilities
{
        ...
        static CodeFixProviderDiscovery()
        {
            ExportProviderFactory = new Lazy<IExportProviderFactory>(
                () =>
                {
                    ...
                    var parts = Task.Run(() => discovery.CreatePartsAsync(typeof(PlugCodeFixProvider).Assembly)).GetAwaiter().GetResult();
