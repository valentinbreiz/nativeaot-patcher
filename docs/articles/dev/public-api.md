...
| `Cosmos.Kernel.HAL.Interfaces` | `IBlockDevice`, `INetworkDevice`, `SoftwareTimer` and `MACAddress`, tracked; the boot, graphics, input and timer contracts internal |
