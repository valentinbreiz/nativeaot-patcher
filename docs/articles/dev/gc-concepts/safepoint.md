...
In OrionGC only the collection-triggering thread sits at safepoints; every other thread is scanned conservatively until hijacking exists ([#385](https://github.com/valentinbreiz/nativeaot-patcher/issues/385)). See [The safepoint constraint](../garbage-collector-gcinfo.md#the-safepoint-constraint).
