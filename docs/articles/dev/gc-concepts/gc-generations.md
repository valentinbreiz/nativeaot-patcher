...
Generational collectors split the heap by object age. The generational hypothesis observes that most objects die young, so collecting only the youngest region (generation 0) reclaims most of the garbage at a fraction of the cost of a full-heap scan; older generations are collected rarely.
